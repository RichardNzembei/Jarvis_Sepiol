...
const SYSTEM_PROMPT = [
  ...
  "- Avoid the standalone words 'stop', 'wait', 'cancel', 'quiet', and 'enough' in",
  "  replies — they are reserved as voice-interrupt commands and the microphone may",
  "  be listening while you speak. Phrase around them.",
  "",
